...
description: Use when executing a planned work ticket from .opencode/tickets/ — branch/worktree setup, following the ticket's ## Plan section, commit style, running builds and tests, addressing PR review feedback, and opening the pull request with gh.
---
...
```markdown
## Ticket
<TICKET-ID> — <title> (`.opencode/tickets/<dir>/<file>`)
