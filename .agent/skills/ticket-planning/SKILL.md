...
description: Use when planning how to implement a specific ticket from .agent/tickets/ — analyzing the affected code, choosing the approach, and writing a concrete step-by-step implementation plan into the ticket's ## Plan section. Planning always precedes execution; the executor follows the plan.
---
...
- Path to the ticket file in `.agent/tickets/…` — read it fully: objective, scope, acceptance criteria, technical notes, any review feedback.
- The repo root.
